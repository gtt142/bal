...
echo ""
echo "<html><head><title>System information</title>"
...
echo "<h2 align='center'> Load Average: "
avg_color $LAVG1
echo ", "
avg_color $LAVG5
echo ", "
...
echo "<tr><th>%(Usr+nice)</th><th>%sys</th><th>%id</th><th>%iowait</th></tr>" 
...
echo "<table width=50% border=1><tr><th>Device</th><th>r/s</th><th>w/s</th><th>await</th><th>%util</th>"
echo "$(cat /var/log/iostat.log | tail -n 3 |awk ' {printf("<tr><td align=center>%s</td><td align=center>%s</td><td align=center>%s</td><td align=center>%s</td><td align=center>%s</td></tr>",$1, $4, $5, $10, $14)}')</table>"

echo "<h1>Load Disks (minute ago)</h1>"
echo "<table width=50% border=1><tr><th>Device</th><th>r/s</th><th>w/s</th><th>await</th><th>%util</th>"
echo "$(cat /var/log/iostat.log | tail -n 9 | head -n 3 |awk ' {printf("<tr><td align=center>%s</td><td align=center>%s</td><td align=center>%s</td><td align=center>%s</td><td align=center>%s</td></tr>",$1, $4, $5, $10, $14)}')</table>"
...
echo "<table border='1' width='50%'>"
echo "<tr><th>inteface</th><th>bytes_received</th><th>packet_received</th><th>bytes_transmit</th><th>packet_transmit</th></tr>"  
...
echo "<pre> TIME_WAIT: $(netstat | grep TIME_WAIT | wc -l )</pre>"
